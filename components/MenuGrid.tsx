...
export function MenuGrid(){
 ...
 return <section id="full-menu" className="fullMenu" aria-labelledby="full-menu-title">
  ...
  <button className="cartBubble" aria-label={`Open cart with ${cartCount} items`} onClick={()=>setCartOpen(true)}><ShoppingBag size={19}/><span>Cart</span><b>{cartCount}</b></button>
